...
const (
	...
	MaxTotalIOPS = 20000
	// MaxNumTagsPerResource represents the maximum number of tags per OSC resource.
...
// ListSnapshots retrieves OSC BSU snapshots for an optionally specified volume ID.  If maxResults is set, it will return up to maxResults snapshots.  If there are more snapshots than maxResults,
