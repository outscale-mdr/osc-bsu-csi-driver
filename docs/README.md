...
| "luks-cipher"                                    | string                |         | LUKS encryption cipher to use  (See [doc](https://wiki.archlinux.org/title/dm-crypt/Device_encryption#Encryption_options_for_LUKS_mode))                    |
| "luks-hash"                                      | string                |         | Derivation Password hash algorithm (See [doc](https://wiki.archlinux.org/title/dm-crypt/Device_encryption#Encryption_options_for_LUKS_mode))     |
| "luks-key-size"                                  | string                |         | Size of the encryption key  (See [doc](https://wiki.archlinux.org/title/dm-crypt/Device_encryption#Encryption_options_for_LUKS_mode))            |
